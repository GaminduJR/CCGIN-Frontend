...
const Addsubmition = () =>
{
    ...
    function senddata(e)
    {
      ...
      axios.post("http://localhost:8070/submition/add_submition",newsubmition).then(()=>{
        alert("submition add")
        setname("");
        setaname("");
        setlink("");
    ...
    return(
      ...
      <form action="#">
       ...
       <input type="text" placeholder="submition name" onChange={e=>{setaname(e.target.value);}}/>
            </div>
         </div>
         <div className="form-row">
            <div className="input-data">
